...
export default class ProductsCrud {
  ...
  init() {
    ...
    this.productsList = document.querySelector('.products-list__items');
  ...
  productDelete(tag) {
    ...
    this.showPopUp(this.deleteConfirm);
  ...
  showPopUp(element) {
    ...
    this.modal.style.left = `${(this.popUp.getBoundingClientRect().width / 2) - (this.modal.getBoundingClientRect().width / 2)}px`;
    this.modal.style.top = `${(this.popUp.getBoundingClientRect().height / 2) - (this.modal.getBoundingClientRect().height / 2)}px`;
    this.eventsDisable();
  }
  ...
  updateList() {
    ...
    this.productsArr.forEach((item) => {
      ...
      this.productsList.append(productDiv);
    });
  }
}
